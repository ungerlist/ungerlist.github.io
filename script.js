...
// Spring 2018
// Web233 Javascript
// Week 12 Assignment - Shopping List Version 4.0
...
function savecookie()
{
  delete_cookie('ungerlist');
   var date = new Date();
   //keeps for a year
    date.setTime(date.getTime() + Number(365) * 3600 * 1000);
   document.cookie = 'ungerlist' + "=" + escape(shoppinglist.join(',')) + "; path=/;expires = " + date.toGMTString();
}
